...
var useFieldArray = function (_a) {
    ...
    var append = function (value, shouldFocus) {
        ...
        !shouldUnregister &&
            set(shallowFieldsStateRef.current, name, __spread((shallowFieldsStateRef.current[name] || []), [
                value,
            ]));
...
var Controller = function (_a) {
    ...
    var onFocusRef = React.useRef(onFocus || (function () { return ref.current.focus(); }));
